...
class MCPServerConfig(BaseModel):
    ...
    model_config = {
        "json_schema_extra": {
            "examples": [
                {"url": "https://mcp-server.example.com/mcp", "transport": "streamable_http", "auth_token": "your-token-here"},  # nosec: B105 - example placeholder token
...
class MCPClientConfig(BaseModel):
    ...
    model_config = {
        "json_schema_extra": {
            "example": {
                "mcp_server": {"url": "https://mcp-server.example.com/mcp", "transport": "streamable_http", "auth_token": "your-token"},  # nosec: B105 - example placeholder token
                "llm": {
                    "provider": "azure_openai",
