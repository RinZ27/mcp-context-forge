        ...
        providers.append(
            {
                ...
                "token_url": "https://github.com/login/oauth/access_token",  # nosec: B105 - well-known OAuth endpoint (not a secret)
        ...
        providers.append(
            {
                ...
                "token_url": "https://oauth2.googleapis.com/token",  # nosec: B105 - public token endpoint URL
